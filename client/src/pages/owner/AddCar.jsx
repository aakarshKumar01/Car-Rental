...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitle="Fill in details to list a ew car for bookings, incuding pricing, availability, and car specifications." />
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
                ...
                <select onChange={e => setCar({...car, fuel_type: e.target.value})} value={car.fuel_type} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
                  ...
                  <option value="Hybrid">Hyybrid</option>
                </select>
          </div>
          <div className='flex flex-col w-full'>

...
const CarDetails = () => {
  const { id } = useParams();
  const {cars, axios, setPickupDate, pickupDate, returnDate, setReturnDate} = useAppContext()
  ...
  return car ? (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
      ...
      >
        <img src={assets.arrow_icon} className="" alt="rotate-180 opacity-65" />
        Back to all cars
      </button>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        onSubmit={handleSubmit} className="shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="return-data">Pickup Date</label>
